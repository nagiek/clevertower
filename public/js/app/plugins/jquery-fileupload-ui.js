(function() {
  (function(factory) {
    "use strict";    if (typeof define === "function" && define.amd) {
      return define(["jquery", "load-image", "i18n!nls/common", "./jquery.fileupload-fp", "templates/photo/pending", "templates/file/download"], factory);
    } else {
    ...
    "use strict";    return $.widget("blueimp.fileupload", $.blueimp.fileupload, {
      ...
      _initEventHandlers: function() {
        ...
        return this._initButtonBarEventHandlers();
      },
