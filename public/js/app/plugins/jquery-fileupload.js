(function() {
  (function(factory) {
    "use strict";    if (typeof define === "function" && define.amd) {
      return define(["jquery", "jqueryuiwidget"], factory);
    } else {
      return factory(window.jQuery);
    }
  })(function($) {
    "use strict";    $.support.xhrFileUpload = !!(window.XMLHttpRequestUpload && window.FileReader);
      ...
      _onProgress: function(e, data) {
        ...
        if (e.lengthComputable) {
          ...
          return this._trigger("progressall", e, {
            ...
            loaded: this._loaded,
            total: this._total,
            bitrate: this._bitrateTimer(now, this._loaded, data.bitrateInterval)
          });
        }
      },
