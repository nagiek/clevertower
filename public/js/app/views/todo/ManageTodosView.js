...
(function() {
  ...
  define(["jquery", "underscore", "parse", 'collections/todo/TodoList', 'models/app/AppState', 'models/todo/TodoModel', 'views/todo/TodoView', 'text!templates/todo/stats.html', 'text!templates/todo/manage.html'], function($, _, Parse, TodoList, AppState, Todo, TodoView, StatsTemplate, ManageTemplate) {
    var ManageTodosView;
    return ManageTodosView = (function(_super) {
      ...
      ManageTodosView.prototype.statsTemplate = _.template(StatsTemplate);
      ...
      ManageTodosView.prototype.initialize = function() {
        ...
        this.$el.html(_.template(ManageTemplate));
      ...
      ManageTodosView.prototype.logOut = function(e) {
        var LoginView;
        Parse.User.logOut();
      ...
      ManageTodosView.prototype.selectFilter = function(e) {
        ...
        return Parse.history.navigate(filterValue);
      };
