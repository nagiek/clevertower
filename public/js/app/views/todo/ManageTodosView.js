(function() {
  ...
  define(["jquery", "underscore", "backbone", 'collections/todo/TodoList', 'models/AppState', 'models/TodoModel', 'views/todo/TodoView', 'templates/todo/stats', 'templates/todo/manage'], function($, _, Parse, TodoList, AppState, Todo, TodoView, StatsTemplate, ManageTemplate) {
    var ManageTodosView;
