(function() {
  ...
  define(["jquery", "underscore", "backbone", 'collections/todo/TodoList', 'models/AppState', 'models/Todo', 'views/todo/Todo', 'templates/todo/stats', 'templates/todo/manage'], function($, _, Parse, TodoList, AppState, Todo, TodoView, StatsTemplate, ManageTemplate) {
    var ManageTodosView;
