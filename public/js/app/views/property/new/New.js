(function() {
  ...
  define(["jquery", "underscore", "backbone", 'models/Property', "i18n!nls/property", "i18n!nls/common", 'templates/property/new/new', 'templates/property/form/_basic'], function($, _, Parse, Property, i18nProperty, i18nCommon) {
    var NewPropertyView;
    return NewPropertyView = (function(_super) {
      ...
      NewPropertyView.prototype.render = function() {
        return this.$el.html(JST["src/js/templates/property/new/new.jst"]({
          property: this.model,
