...
this["JST"]["src/js/templates/property/new.jst"] = function(obj) {
obj || (obj = {});
...
((__t = ( property.description ? 'value="' + property.description + '"' : ''  )) == null ? '' : __t) +
'>\n        </div>\n      </div>\n    </div>\n  </fieldset>\n  \n  <fieldset>\n    <legend>' +
((__t = ( i18nProperty.form.structure.contact )) == null ? '' : __t) +
'</legend>\n    <div class="row">\n      <div class="control-group span">\n        <label for="property-phone" class="control-label">' +
((__t = ( i18nProperty.fields.phone )) == null ? '' : __t) +
'</label>\n        <div class="controls">\n          <input type="text" name="property[phone]" id="property-phone" class="span3" ' +
...
'>\n        </div>\n      </div>\n    </div>\n  </fieldset>\n  \n  <!-- DO NOT DELETE. MOVE TO LISTING FORM -->\n  <!-- <fieldset>\n    <legend>' +
((__t = ( i18nProperty.form.structure.marketing )) == null ? '' : __t) +
'</legend>\n    <div class="row">\n      <div class="control-group span">\n        <label for="image-fields" class="control-label">' +
((__t = ( i18nProperty.fields.photos )) == null ? '' : __t) +
'</label>\n        <div id="image-fields" class="controls">\n          <div class="span6"></div>\n        </div>\n        <button id="image-add-another" \n                class="btn" \n                data-association-insertion-node="#image-fields"\n                data-association-insertion-method="append">' +
((__t = ( i18nCommon.actions.add_another )) == null ? '' : __t) +
