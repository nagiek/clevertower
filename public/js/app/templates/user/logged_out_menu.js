...
'</a></li>\n<li class="hidden-sm"><a id="signup-link" href="#">' +
((__t = ( i18nDevise.actions.signup )) == null ? '' : __t) +
'</a></li>\n<li class="visible-sm" ><a href="#" data-target="#search-menu" data-toggle="collapse"><span class="glyphicon glyphicon-search"></span></a></li>';
